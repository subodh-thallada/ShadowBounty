      ...
      <div className="bg-zinc-950 border border-zinc-800 shadow-sm rounded-sm overflow-hidden">
        ...
        <div className="p-6 border-b border-zinc-800 bg-zinc-900">
          <div className="flex justify-between items-center">
            ...
            <Link
              ...
              className="px-4 py-2 border border-zinc-700 rounded-sm text-sm font-medium text-white bg-zinc-950 hover:bg-zinc-800 focus:outline-none transition-colors"
            >
              Project Settings
            </Link>
          </div>
          ...
          <div className="mt-4 flex items-center text-sm text-gray-500">
            ...
            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="hover:text-white hover:underline transition-colors">
        ...
        <div className="border-b border-zinc-800">
          <nav className="flex -mb-px">
            <button
              className={`py-4 px-6 text-center border-b-2 font-medium text-sm transition-colors ${activeTab === 'issues'
                  ? 'border-white text-white'
                  : 'border-transparent text-gray-500 hover:text-gray-300 hover:border-zinc-700'
                }`}
            ...
            <button
              className={`py-4 px-6 text-center border-b-2 font-medium text-sm transition-colors ${activeTab === 'bounties'
                  ? 'border-white text-white'
                  : 'border-transparent text-gray-500 hover:text-gray-300 hover:border-zinc-700'
                }`}
