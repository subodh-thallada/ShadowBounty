...
const defaultPersonas: Persona[] = [
  {
    name: "CodeCarla",
    personality: { humor: 6, empathy: 7, expertise: 9 },
    triggers: ["code", "bug", "feature"],
  },
  {
    name: "ZenZara",
    personality: { humor: 5, empathy: 10, expertise: 8 },
    triggers: ["stress", "meditation", "balance"],
  },
  {
    name: "MemeLordMax",
    personality: { humor: 10, empathy: 4, expertise: 6 },
    triggers: ["meme", "lol", "roast"],
  },
]
...
export function PersonaLibrary() {
  ...
  const [newPersona, setNewPersona] = useState<Persona>({
    name: "",
    personality: { humor: 5, empathy: 5, expertise: 5 },
    triggers: [],
  })
          ...
          <Card key={persona.name}>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div>
                  <Label>Empathy: {persona.personality.empathy}</Label>
                  <Slider value={[persona.personality.empathy]} max={10} step={1} disabled />
                </div>
                <div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <div>
              <Label>Empathy: {newPersona.personality.empathy}</Label>
              <Slider
                value={[newPersona.personality.empathy]}
                max={10}
                step={1}
                onValueChange={(value) =>
                  setNewPersona({
                    ...newPersona,
                    personality: { ...newPersona.personality, empathy: value[0] },
                  })
                }
              />
            </div>
